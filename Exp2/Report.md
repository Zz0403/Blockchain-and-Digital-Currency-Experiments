...
本实验使用 Elliptic 比特币交易数据集，主要包含两个 CSV 文件，数据集说明见表 2-1 ：
...
TuGraph 服务实例创建结果以及 TuGraph Browser 登录成功的界面见图 3-1，3-2。

<div align="center">
  <img src="./figs/01.png" alt="TuGraph 服务实例创建成功">
</div>

<p align="center">图 3-1 TuGraph 服务实例创建成功</p>

<div align="center">
  <img src="./figs/02.png" alt="TuGraph Browser 登录成功">
</div>
...
图 3-3，3-4，3-5 分别展示了顶点建模、边建模以及图模型。

<div align="center">
  <img src="./figs/03.png" alt="BitcoinTx 顶点建模">
</div>

<p align="center">图 3-3 BitcoinTx 顶点建模</p>

<div align="center">
  <img src="./figs/04.png" alt="TRANSFER_TO 边建模">
</div>

<p align="center">图 3-4 TRANSFER_TO 边建模</p>

<div align="center">
  <img src="./figs/05.png" alt="图模型整体">
</div>
...
图 3-6，3-7，3-8，3-9 分别展示了点数据导入配置、点数据导入成功、边数据导入配置以及边数据导入成功的界面。

<div align="center">
  <img src="./figs/06.png" alt="点数据导入配置">
</div>

<p align="center">图 3-6 点数据导入配置</p>

<div align="center">
  <img src="./figs/07.png" alt="点数据导入成功">
</div>

<p align="center">图 3-7 点数据导入成功</p>

<div align="center">
  <img src="./figs/08.png" alt="边数据导入配置">
</div>

<p align="center">图 3-8 边数据导入配置</p>

<div align="center">
  <img src="./figs/09.png" alt="边数据导入成功">
</div>
...
图 3-10，3-11，3-12 分别展示了节点数量验证、边数量验证以及交易类别统计的结果，经验证与数据集一致，说明数据导入无误。

<div align="center">
  <img src="./figs/10.png" alt="节点数量验证">
</div>

<p align="center">图 3-10 节点数量验证</p>

<div align="center">
  <img src="./figs/11.png" alt="边数量验证">
</div>

<p align="center">图 3-11 边数量验证</p>

<div align="center">
  <img src="./figs/12.png" alt="交易类别统计">
</div>
...
图 6-1 展示了 `enable_plugin` 参数修改成功的终端界面。

<div align="center">
  <img src="./figs/13.png" alt="enable_plugin 参数修改成功">
</div>
...
在 TuGraph Web 管理界面中进入存储过程管理页面，上传 `ceshi_pagerank.py`，类型选择 Python。图 6-2，6-3 展示了 PageRank 存储过程上传和保存成功的界面。

<div align="center">
  <img src="./figs/14.png" alt="PageRank 上传">
</div>

<p align="center">图 6-2 PageRank 存储过程上传</p>

<div align="center">
  <img src="./figs/15.png" alt="PageRank 编译保存成功">
</div>
...
点击“执行”按钮后，PageRank 存储过程成功运行， 输出界面见图 7-1。

<div align="center">
  <img src="./figs/16.png" alt="PageRank 运行成功">
</div>
...
为了进一步观察高 PageRank 交易中的风险结构，本实验继续运行 `top_k = 100`，并对前 100 个交易按类别进行统计。统计结果见表 7-2（原始运行结果见 `results/PageRank_Top100_Result.json`）：
...
根据 Top-100 结果，本实验重点整理两类风险交易：一类是已标记为非法的高 PageRank 交易，另一类是排名靠前但类别未知的交易。整理结果见表 7-3 ：
